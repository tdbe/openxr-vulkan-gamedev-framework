...
namespace Game
{
    ...
    struct CModel final : public GameComponent
    {
      public:
        size_t firstIndex = 0u;
        size_t indexCount = 0u;
        /// [tdbe] object-space mesh bounds; not processed by the entity's CTransform Matrix. 
        /// Use the <see cref="CBounds"/> and <see cref="CTransform"/> components instead.
        ...
        CModel(GameDataId::ID id = {}, GameDataId::ID owner = {}) : GameComponent(id, owner)
        {
        };
        ~CModel() {};
    };
