...
namespace Game
{
    ...
    struct SystemTransformPropagation : SystemBase
    {
        ...
        /// This is the main entry point for the transform propagation system.
      ...
      private:
        ...
        template<typename SubpoolT> void ArchetypeChildEntityJobInChunk(
            ...
            // const typename ArchetypedGameDataPool<GameEntityObject, Transform, Parent, Children, Bounds>
        ...
        void RecursiveEntityTraversalTasksFromRootEntities()
        {
            ...
            const auto& entitySubpool = GameData::Instance().entityObjectsWorld->entityArchetypePool->GetSubpoolByType<GameEntityObject>();
